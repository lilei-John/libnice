...
pkgdatadir = $(datadir)/libnice
pkglibdir = $(libdir)/libnice
pkglibexecdir = $(libexecdir)/libnice
...
ACLOCAL = ${SHELL} /opt/p2p/libnice/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /opt/p2p/libnice/missing autoconf
AUTOHEADER = ${SHELL} /opt/p2p/libnice/missing autoheader
AUTOMAKE = ${SHELL} /opt/p2p/libnice/missing automake-1.15
AWK = mawk
CC = gcc
CCACHE_DISABLE = 
...
GLIB_LIBS = -lgio-2.0 -lgobject-2.0 -lgthread-2.0 -pthread -lglib-2.0
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /opt/p2p/libnice/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = libnice 0.1.14.1
PACKAGE_TARNAME = libnice
PACKAGE_URL = 
PACKAGE_VERSION = 0.1.14.1
PATH_SEPARATOR = :
...
UPNP_ENABLED = 
VERSION = 0.1.14.1
abs_builddir = /opt/p2p/libnice
abs_srcdir = /opt/p2p/libnice
abs_top_builddir = /opt/p2p/libnice
abs_top_srcdir = /opt/p2p/libnice
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /opt/p2p/libnice/install-sh
...
top_builddir = .
top_srcdir = .
CLEANFILES = *.gcno *.gcda win32/vs9/libnice.def
